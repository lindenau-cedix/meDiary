...
for key in PORT DB_PATH DEFAULTS_PATH DIARY_PATH ANTHROPIC_API_KEY ANTHROPIC_BASE_URL DIARY_MODEL DIARY_THINKING DIARY_MAX_TOKENS CF_ACCESS_TEAM_DOMAIN CF_ACCESS_AUD CF_ACCESS_CERTS_URL CF_ACCESS_DISABLED; do
